...
struct system {
  ...
  struct run_config {
    std::function<asio::awaitable<void>(ecs_type&, double)> handler;
  };
  ...
  system(run_config<FuncT, Policy, entt::get_t<ComponentsT...>, entt::exclude_t<ExcludeT...>>&& cfg, ecs_type& ecs) {
    ...
    run = [cfg = std::move(cfg), view = ecs.template view<ComponentsT...>(entt::exclude_t<ExcludeT...>{}), this](system& self, ecs_type& ecs, double dt) mutable -> asio::awaitable<bool> {
  ...
  system(each_config<FuncT, Policy, entt::get_t<ComponentsT...>, entt::exclude_t<ExcludeT...>>&& cfg, ecs_type& ecs) {
    ...
    run = [cfg = std::move(cfg), view = ecs.template view<ComponentsT...>(entt::exclude_t<running<FuncT>, running<FuncT, run_once_tag>, ExcludeT...>{}), this](system& self, ecs_type& ecs, double dt) mutable -> asio::awaitable<bool> {
      auto executor = co_await asio::this_coro::executor;
  ...
  static asio::awaitable<void> each_parallel(ExecutorT& executor, ecs_type& ecs, double dt, FuncT handler, ViewT& view, run_policy_t<Policy> = {}) {
  ...
  static asio::awaitable<bool> each_parallel_detached(MainExecutorT& main_executor, ConcurrentExecutorT& concurrent_executor, ecs_type& ecs, double dt, FuncT handler, ViewT& view, run_policy_t<Policy> = {}) {
  ...
  static asio::awaitable<void> run_parallel(ExecutorT& executor, ecs_type& ecs, double dt, FuncT handler, ViewT& view) {
...
struct system_builder<entt::get_t<ComponentsT...>, entt::exclude_t<ExcludeT...>> {
  ...
  template <typename FuncT, run_policy Policy = run_policy::automatic, typename = std::enable_if_t<std::is_invocable_v<FuncT, entt_ext::ecs&, double, ViewT&>>>
